...
"""Neural Network SARSA frozen candidate (Representation B).
...
sarsa_c (learning_rate=3e-4, gamma=0.98, epsilon_final=0.03), seed 20260826, 500,000 transitions. Uses Representation B (raw + engineered,
